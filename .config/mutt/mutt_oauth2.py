...
# although won't work until an appropriate identity appears in the --recipient.
ENCRYPTION_PIPE = ['gpg', '--encrypt', '--recipient', 'jorge@tokunaga.mx'] # O tu ID de clave GPG
...
registrations = {
    ...
    'microsoft': {
        ...
        'client_id': 'TU_CLIENT_ID_DE_AZURE_AD', # ¡REEMPLAZA ESTO!
        'client_secret': 'TU_CLIENT_SECRET_DE_AZURE_AD', # ¡REEMPLAZA ESTO!
    },
}
